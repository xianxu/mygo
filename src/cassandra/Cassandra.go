...
type ICassandra interface {
	 ...
	 *  - ConsistencyLevel
	 */
	Get(key []byte, column_path *ColumnPath, consistency_level ConsistencyLevel) (retval330 *ColumnOrSuperColumn, ire *InvalidRequestException, nfe *NotFoundException, ue *UnavailableException, te *TimedOutException, err error)
	/**
	 ...
	 *  - ConsistencyLevel
	 */
	GetSlice(key []byte, column_parent *ColumnParent, predicate *SlicePredicate, consistency_level ConsistencyLevel) (retval331 thrift.TList, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error)
	/**
	 ...
	 *  - ConsistencyLevel
	 */
	GetCount(key []byte, column_parent *ColumnParent, predicate *SlicePredicate, consistency_level ConsistencyLevel) (retval332 int32, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error)
	/**
	 ...
	 *  - ConsistencyLevel
	 */
	MultigetSlice(keys thrift.TList, column_parent *ColumnParent, predicate *SlicePredicate, consistency_level ConsistencyLevel) (retval333 thrift.TMap, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error)
	/**
	 ...
	 *  - ConsistencyLevel
	 */
	MultigetCount(keys thrift.TList, column_parent *ColumnParent, predicate *SlicePredicate, consistency_level ConsistencyLevel) (retval334 thrift.TMap, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error)
	/**
	 ...
	 *  - ConsistencyLevel
	 */
	GetRangeSlices(column_parent *ColumnParent, predicate *SlicePredicate, range_a1 *KeyRange, consistency_level ConsistencyLevel) (retval335 thrift.TList, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error)
	/**
	 ...
	 *  - ConsistencyLevel
	 */
	GetIndexedSlices(column_parent *ColumnParent, index_clause *IndexClause, column_predicate *SlicePredicate, consistency_level ConsistencyLevel) (retval336 thrift.TList, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error)
	/**
	 ...
	 */
	DescribeSchemaVersions() (retval343 thrift.TMap, ire *InvalidRequestException, err error)
	/**
	 * list the defined keyspaces in this cluster
	 */
	DescribeKeyspaces() (retval344 thrift.TList, ire *InvalidRequestException, err error)
	/**
	 * get the cluster name
	 */
	DescribeClusterName() (retval345 string, err error)
	/**
	 * get the thrift api version
	 */
	DescribeVersion() (retval346 string, err error)
	/**
	 ...
	 *  - Keyspace
	 */
	DescribeRing(keyspace string) (retval347 thrift.TList, ire *InvalidRequestException, err error)
	/**
	 * returns the partitioner used by this cluster
	 */
	DescribePartitioner() (retval348 string, err error)
	/**
	 * returns the snitch used by this cluster
	 */
	DescribeSnitch() (retval349 string, err error)
	/**
	 ...
	 *  - Keyspace
	 */
	DescribeKeyspace(keyspace string) (retval350 *KsDef, nfe *NotFoundException, ire *InvalidRequestException, err error)
	/**
	 ...
	 *  - KeysPerSplit
	 */
	DescribeSplits(cfName string, start_token string, end_token string, keys_per_split int32) (retval351 thrift.TList, ire *InvalidRequestException, err error)
	/**
	 ...
	 *  - CfDef
	 */
	SystemAddColumnFamily(cf_def *CfDef) (retval352 string, ire *InvalidRequestException, sde *SchemaDisagreementException, err error)
	/**
	 ...
	 *  - ColumnFamily
	 */
	SystemDropColumnFamily(column_family string) (retval353 string, ire *InvalidRequestException, sde *SchemaDisagreementException, err error)
	/**
	 ...
	 *  - KsDef
	 */
	SystemAddKeyspace(ks_def *KsDef) (retval354 string, ire *InvalidRequestException, sde *SchemaDisagreementException, err error)
	/**
	 ...
	 *  - Keyspace
	 */
	SystemDropKeyspace(keyspace string) (retval355 string, ire *InvalidRequestException, sde *SchemaDisagreementException, err error)
	/**
	 ...
	 *  - KsDef
	 */
	SystemUpdateKeyspace(ks_def *KsDef) (retval356 string, ire *InvalidRequestException, sde *SchemaDisagreementException, err error)
	/**
	 ...
	 *  - CfDef
	 */
	SystemUpdateColumnFamily(cf_def *CfDef) (retval357 string, ire *InvalidRequestException, sde *SchemaDisagreementException, err error)
	/**
	 ...
	 *  - Compression
	 */
	ExecuteCqlQuery(query []byte, compression Compression) (retval358 *CqlResult, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, sde *SchemaDisagreementException, err error)
}
...
func (p *CassandraClient) RecvLogin() (authnx *AuthenticationException, authzx *AuthorizationException, err error) {
	...
	if result361.Authnx != nil {
		authnx = result361.Authnx
	}
	if result361.Authzx != nil {
		authzx = result361.Authzx
	}
	return
}
 ...
 *  - ConsistencyLevel
 */
func (p *CassandraClient) Get(key []byte, column_path *ColumnPath, consistency_level ConsistencyLevel) (retval369 *ColumnOrSuperColumn, ire *InvalidRequestException, nfe *NotFoundException, ue *UnavailableException, te *TimedOutException, err error) {
 ...
 *  - ConsistencyLevel
 */
func (p *CassandraClient) GetSlice(key []byte, column_parent *ColumnParent, predicate *SlicePredicate, consistency_level ConsistencyLevel) (retval374 thrift.TList, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error) {
 ...
 *  - ConsistencyLevel
 */
func (p *CassandraClient) GetCount(key []byte, column_parent *ColumnParent, predicate *SlicePredicate, consistency_level ConsistencyLevel) (retval379 int32, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error) {
 ...
 *  - ConsistencyLevel
 */
func (p *CassandraClient) MultigetSlice(keys thrift.TList, column_parent *ColumnParent, predicate *SlicePredicate, consistency_level ConsistencyLevel) (retval384 thrift.TMap, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error) {
 ...
 *  - ConsistencyLevel
 */
func (p *CassandraClient) MultigetCount(keys thrift.TList, column_parent *ColumnParent, predicate *SlicePredicate, consistency_level ConsistencyLevel) (retval389 thrift.TMap, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error) {
 ...
 *  - ConsistencyLevel
 */
func (p *CassandraClient) GetRangeSlices(column_parent *ColumnParent, predicate *SlicePredicate, range_a1 *KeyRange, consistency_level ConsistencyLevel) (retval394 thrift.TList, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error) {
 ...
 *  - ConsistencyLevel
 */
func (p *CassandraClient) GetIndexedSlices(column_parent *ColumnParent, index_clause *IndexClause, column_predicate *SlicePredicate, consistency_level ConsistencyLevel) (retval399 thrift.TList, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error) {
 ...
 * the cluster is all on the same version if the size of the map is 1.
 */
func (p *CassandraClient) DescribeSchemaVersions() (retval434 thrift.TMap, ire *InvalidRequestException, err error) {
 ...
 * list the defined keyspaces in this cluster
 */
func (p *CassandraClient) DescribeKeyspaces() (retval439 thrift.TList, ire *InvalidRequestException, err error) {
 ...
 * get the cluster name
 */
func (p *CassandraClient) DescribeClusterName() (retval444 string, err error) {
 ...
 * get the thrift api version
 */
func (p *CassandraClient) DescribeVersion() (retval449 string, err error) {
 ...
 *  - Keyspace
 */
func (p *CassandraClient) DescribeRing(keyspace string) (retval454 thrift.TList, ire *InvalidRequestException, err error) {
 ...
 * returns the partitioner used by this cluster
 */
func (p *CassandraClient) DescribePartitioner() (retval459 string, err error) {
 ...
 * returns the snitch used by this cluster
 */
func (p *CassandraClient) DescribeSnitch() (retval464 string, err error) {
 ...
 *  - Keyspace
 */
func (p *CassandraClient) DescribeKeyspace(keyspace string) (retval469 *KsDef, nfe *NotFoundException, ire *InvalidRequestException, err error) {
 ...
 *  - KeysPerSplit
 */
func (p *CassandraClient) DescribeSplits(cfName string, start_token string, end_token string, keys_per_split int32) (retval474 thrift.TList, ire *InvalidRequestException, err error) {
 ...
 *  - CfDef
 */
func (p *CassandraClient) SystemAddColumnFamily(cf_def *CfDef) (retval479 string, ire *InvalidRequestException, sde *SchemaDisagreementException, err error) {
 ...
 *  - ColumnFamily
 */
func (p *CassandraClient) SystemDropColumnFamily(column_family string) (retval484 string, ire *InvalidRequestException, sde *SchemaDisagreementException, err error) {
 ...
 *  - KsDef
 */
func (p *CassandraClient) SystemAddKeyspace(ks_def *KsDef) (retval489 string, ire *InvalidRequestException, sde *SchemaDisagreementException, err error) {
 ...
 *  - Keyspace
 */
func (p *CassandraClient) SystemDropKeyspace(keyspace string) (retval494 string, ire *InvalidRequestException, sde *SchemaDisagreementException, err error) {
 ...
 *  - KsDef
 */
func (p *CassandraClient) SystemUpdateKeyspace(ks_def *KsDef) (retval499 string, ire *InvalidRequestException, sde *SchemaDisagreementException, err error) {
 ...
 *  - CfDef
 */
func (p *CassandraClient) SystemUpdateColumnFamily(cf_def *CfDef) (retval504 string, ire *InvalidRequestException, sde *SchemaDisagreementException, err error) {
 ...
 *  - Compression
 */
func (p *CassandraClient) ExecuteCqlQuery(query []byte, compression Compression) (retval509 *CqlResult, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, sde *SchemaDisagreementException, err error) {
...
func (p *MultigetSliceArgs) WriteField1(oprot thrift.TProtocol) (err thrift.TProtocolException) {
	if p.Keys != nil {
		...
		for Iter623 := range p.Keys.Iter() {
			Iter624 := Iter623.([]byte)
			err = oprot.WriteBinary(Iter624)
			if err != nil {
...
func (p *MultigetSliceResult) WriteField0(oprot thrift.TProtocol) (err thrift.TProtocolException) {
	if p.Success != nil {
		...
		for Miter656 := range p.Success.Iter() {
			Kiter657, Viter658 := Miter656.Key().([]byte), Miter656.Value().(thrift.TList)
			err = oprot.WriteBinary(Kiter657)
			if err != nil {
...
func (p *MultigetCountArgs) WriteField1(oprot thrift.TProtocol) (err thrift.TProtocolException) {
	if p.Keys != nil {
		...
		for Iter679 := range p.Keys.Iter() {
			Iter680 := Iter679.([]byte)
			err = oprot.WriteBinary(Iter680)
			if err != nil {
...
func (p *MultigetCountResult) WriteField0(oprot thrift.TProtocol) (err thrift.TProtocolException) {
	if p.Success != nil {
		...
		for Miter703 := range p.Success.Iter() {
			Kiter704, Viter705 := Miter703.Key().([]byte), Miter703.Value().(int32)
			err = oprot.WriteBinary(Kiter704)
			if err != nil {
...
func (p *BatchMutateArgs) WriteField1(oprot thrift.TProtocol) (err thrift.TProtocolException) {
	if p.MutationMap != nil {
		...
		for Miter879 := range p.MutationMap.Iter() {
			Kiter880, Viter881 := Miter879.Key().([]byte), Miter879.Value().(thrift.TMap)
			err = oprot.WriteBinary(Kiter880)
			if err != nil {
