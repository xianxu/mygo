...
func Usage() {
	...
	fmt.Fprint(os.Stderr, "  get(key []byte, column_path *ColumnPath, consistency_level ConsistencyLevel) (retval1094 *ColumnOrSuperColumn, ire *InvalidRequestException, nfe *NotFoundException, ue *UnavailableException, te *TimedOutException, err error)\n")
	fmt.Fprint(os.Stderr, "  get_slice(key []byte, column_parent *ColumnParent, predicate *SlicePredicate, consistency_level ConsistencyLevel) (retval1095 thrift.TList, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error)\n")
	fmt.Fprint(os.Stderr, "  get_count(key []byte, column_parent *ColumnParent, predicate *SlicePredicate, consistency_level ConsistencyLevel) (retval1096 int32, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error)\n")
	fmt.Fprint(os.Stderr, "  multiget_slice(keys thrift.TList, column_parent *ColumnParent, predicate *SlicePredicate, consistency_level ConsistencyLevel) (retval1097 thrift.TMap, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error)\n")
	fmt.Fprint(os.Stderr, "  multiget_count(keys thrift.TList, column_parent *ColumnParent, predicate *SlicePredicate, consistency_level ConsistencyLevel) (retval1098 thrift.TMap, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error)\n")
	fmt.Fprint(os.Stderr, "  get_range_slices(column_parent *ColumnParent, predicate *SlicePredicate, range_a1 *KeyRange, consistency_level ConsistencyLevel) (retval1099 thrift.TList, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error)\n")
	fmt.Fprint(os.Stderr, "  get_indexed_slices(column_parent *ColumnParent, index_clause *IndexClause, column_predicate *SlicePredicate, consistency_level ConsistencyLevel) (retval1100 thrift.TList, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error)\n")
	...
	fmt.Fprint(os.Stderr, "  add(key []byte, column_parent *ColumnParent, column *CounterColumn, consistency_level ConsistencyLevel) (ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error)\n")
	...
	fmt.Fprint(os.Stderr, "  remove_counter(key []byte, path *ColumnPath, consistency_level ConsistencyLevel) (ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, err error)\n")
	...
	fmt.Fprint(os.Stderr, "  describe_schema_versions() (retval1107 thrift.TMap, ire *InvalidRequestException, err error)\n")
	fmt.Fprint(os.Stderr, "  describe_keyspaces() (retval1108 thrift.TList, ire *InvalidRequestException, err error)\n")
	fmt.Fprint(os.Stderr, "  describe_cluster_name() (retval1109 string, err error)\n")
	fmt.Fprint(os.Stderr, "  describe_version() (retval1110 string, err error)\n")
	fmt.Fprint(os.Stderr, "  describe_ring(keyspace string) (retval1111 thrift.TList, ire *InvalidRequestException, err error)\n")
	fmt.Fprint(os.Stderr, "  describe_partitioner() (retval1112 string, err error)\n")
	fmt.Fprint(os.Stderr, "  describe_snitch() (retval1113 string, err error)\n")
	fmt.Fprint(os.Stderr, "  describe_keyspace(keyspace string) (retval1114 *KsDef, nfe *NotFoundException, ire *InvalidRequestException, err error)\n")
	fmt.Fprint(os.Stderr, "  describe_splits(cfName string, start_token string, end_token string, keys_per_split int32) (retval1115 thrift.TList, ire *InvalidRequestException, err error)\n")
	fmt.Fprint(os.Stderr, "  system_add_column_family(cf_def *CfDef) (retval1116 string, ire *InvalidRequestException, sde *SchemaDisagreementException, err error)\n")
	fmt.Fprint(os.Stderr, "  system_drop_column_family(column_family string) (retval1117 string, ire *InvalidRequestException, sde *SchemaDisagreementException, err error)\n")
	fmt.Fprint(os.Stderr, "  system_add_keyspace(ks_def *KsDef) (retval1118 string, ire *InvalidRequestException, sde *SchemaDisagreementException, err error)\n")
	fmt.Fprint(os.Stderr, "  system_drop_keyspace(keyspace string) (retval1119 string, ire *InvalidRequestException, sde *SchemaDisagreementException, err error)\n")
	fmt.Fprint(os.Stderr, "  system_update_keyspace(ks_def *KsDef) (retval1120 string, ire *InvalidRequestException, sde *SchemaDisagreementException, err error)\n")
	fmt.Fprint(os.Stderr, "  system_update_column_family(cf_def *CfDef) (retval1121 string, ire *InvalidRequestException, sde *SchemaDisagreementException, err error)\n")
	fmt.Fprint(os.Stderr, "  execute_cql_query(query []byte, compression Compression) (retval1122 *CqlResult, ire *InvalidRequestException, ue *UnavailableException, te *TimedOutException, sde *SchemaDisagreementException, err error)\n")
...
func main() {
	...
	case "get":
		...
		value2 := argvalue2
		fmt.Print(client.Get([]byte(value0), value1, value2))
		fmt.Print("\n")
		break
	case "get_slice":
		if flag.NArg()-1 != 4 {
		...
		value3 := argvalue3
		fmt.Print(client.GetSlice([]byte(value0), value1, value2, value3))
		fmt.Print("\n")
		break
	case "get_count":
		if flag.NArg()-1 != 4 {
		...
		argvalue3 := cassandra.ConsistencyLevel(tmp3)
		value3 := argvalue3
		fmt.Print(client.GetCount([]byte(value0), value1, value2, value3))
		fmt.Print("\n")
		break
	case "multiget_slice":
		if flag.NArg()-1 != 4 {
	...
	case "insert":
		...
		argvalue3 := cassandra.ConsistencyLevel(tmp3)
		value3 := argvalue3
		fmt.Print(client.Insert([]byte(value0), value1, value2, value3))
		fmt.Print("\n")
		break
	case "add":
		if flag.NArg()-1 != 4 {
		...
		argvalue3 := cassandra.ConsistencyLevel(tmp3)
		value3 := argvalue3
		fmt.Print(client.Add([]byte(value0), value1, value2, value3))
		fmt.Print("\n")
		break
	case "remove":
		if flag.NArg()-1 != 4 {
		...
		value1 := argvalue1
		argvalue2, err1268 := (strconv.ParseInt(flag.Arg(3), 10, 64))
		if err1268 != nil {
			Usage()
			return
		}
		...
		argvalue3 := cassandra.ConsistencyLevel(tmp3)
		value3 := argvalue3
		fmt.Print(client.Remove([]byte(value0), value1, value2, value3))
		fmt.Print("\n")
		break
	case "remove_counter":
		if flag.NArg()-1 != 3 {
		...
		argvalue2 := cassandra.ConsistencyLevel(tmp2)
		value2 := argvalue2
		fmt.Print(client.RemoveCounter([]byte(value0), value1, value2))
		fmt.Print("\n")
		break
	case "batch_mutate":
		if flag.NArg()-1 != 2 {
	...
	case "execute_cql_query":
		...
		value1 := argvalue1
		fmt.Print(client.ExecuteCqlQuery([]byte(value0), value1))
		fmt.Print("\n")
		break
	case "":
		Usage()
